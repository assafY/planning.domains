...
public class Domain {
    ...
    public static class Requirements {
        ...
        public String toString() {
            ...
            if (strips != null) {toReturn += "strips\n";}
            if (typing != null) {toReturn += "typing\n";}
            if (durative != null) {toReturn += "durative-actions\n";}
            if (fluents != null) {toReturn += "fluents\n";}
            if (timed != null) {toReturn += "timed-initial-literals\n";}
            return toReturn;
        }
    }
